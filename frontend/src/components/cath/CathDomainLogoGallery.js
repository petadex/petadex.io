...
/**
 * @param {{ logos: import("../../data/cathDomainCatalog.js").CathDomainLogo[], sectionId: string, title: string, emptyNote: string }} props
 */
...
/**
 * @param {object} props
 * @param {import("../../data/cathDomainCatalog.js").CathDomainLogo[]} props.hmmLogos
 * @param {import("../../data/cathDomainCatalog.js").CathDomainLogo[]} props.sequenceLogos
 */
const CathDomainLogoGallery = ({ hmmLogos, sequenceLogos }) => (
  <>
    <LogoGrid
      logos={hmmLogos}
...
export default CathDomainLogoGallery

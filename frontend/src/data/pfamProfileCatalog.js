 ...
 * @typedef {{ caption: string, imageSrc?: string|null, alt?: string }} PfamProfileFigure
 *
 * @typedef {Object} PfamProfileCatalogEntry
 ...
 * @property {PfamProfileReference[]} references
 * @property {PfamProfileLegendSegment[]} [legendSegments]
 * @property {(string|PfamProfileFigure)[]} [figures]  Strings treated as caption-only figures
...
/** @type {PfamProfileCatalogEntry[]} */
export const PFAM_PROFILE_CATALOG = [
  {
    id: "pf-PF10605",

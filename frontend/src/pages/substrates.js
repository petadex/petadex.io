...
const substratesData = [
  ...
  },
  {
    ...
    references: [
      { text: "Xu et al., 2025 (Biofuels, Bioproducts and Biorefinering)", url: "https://doi.org/10.1002/bbb.70000" },
  ...
  },
  {
    ...
    abstract: "Polyvinyl chloride (PVC), behind only polyethylene and polypropylene, is the world's third-most widely produced synthetic polymer. It is a thermoplastic polymer composed of repeating chloroethyl units. In its pure, uncompounded form, PVC is a colourless or white in its pure form, rigid, and brittle solid. However, the addition of plasticizers, stabilizers, and other additives allows its properties to be modified extensively, resulting in both rigid and flexible forms. It is biologically and chemically resistant, making it the plastic of choice for pipes and other applications where corrosion would limit the use of metal. Flexible PVC, achieved through plasticization, is used in tubing, cable insulation, and clothing.",
    references: [
...
const SubstratesPage = () => {
  ...
  return (
    <Layout>
      <div className="flex flex-col md:flex-row min-h-[calc(100vh-80px)] bg-background text-foreground transition-colors">
        
        {/* LEFT COLUMN: Polymer Selector Sidebar */}
        <nav className="w-full md:w-72 bg-card border-b md:border-b-0 md:border-r border-border p-5 overflow-y-auto max-h-none md:max-h-[calc(100vh-80px)]">
        ...
        <main className="flex-1 grid grid-cols-1 xl:grid-cols-2 gap-8 p-6 md:p-10">
          ...
          <div className="flex flex-col h-full min-h-[450px] xl:min-h-0">
            <div className="flex-1 bg-neutral-950 border border-border rounded-xl overflow-hidden relative shadow-md">
              {/* Changed prop from pdbId to accession, and now selectedPdb holds the full S3 URL */}
              <ProteinViewer accession={selectedPdb} />
            </div>
